	...
	<div class="container_box5">
		<div class="container5">
			...
			<ul class="container5list">
				<li class="container5list_0"><img src="resources/res/images/index_foot/hotel_2/04.jpg"><div><p style="font-size: 13px">木屋</p><p style="font-size: 12px;color: #cccccc">10309间木屋</p></div></li>
				<li class="container5list_1"><img src="resources/res/images/index_foot/hotel_2/05.jpg"><div><p style="font-size: 13px">乡村别墅</p><p style="font-size: 12px;color: #cccccc">10439栋别墅</p></div></li>
				<li class="container5list_2"><img src="resources/res/images/index_foot/hotel_2/06.jpg"><div><p style="font-size: 13px">豪华帐篷</p><p style="font-size: 12px;color: #cccccc">10129处豪华帐篷地</p></div></li>
				<li class="container5list_3"><img src="resources/res/images/index_foot/hotel_2/07.jpg"><div><p style="font-size: 13px">公寓式酒店</p><p style="font-size: 12px;color: #cccccc">25309家公寓式酒店</p></div></li>
				<li class="container5list_4"><img src="resources/res/images/index_foot/hotel_2/08.jpg"><div><p style="font-size: 13px">度假屋</p><p style="font-size: 12px;color: #cccccc">63309间度假屋</p></div></li>
				<li class="container5list_5"><img src="resources/res/images/index_foot/hotel_2/09.jpg"><div><p style="font-size: 13px">旅馆</p><p style="font-size: 12px;color: #cccccc">45309家旅馆</p></div></li>

				<li class="container5list_6"><img src="resources/res/images/index_foot/hotel_2/01.jpg"><div><p style="font-size: 13px">公寓</p><p style="font-size: 12px;color: #cccccc">45681栋公寓</p></div></li>
				<li class="container5list_7"><img src="resources/res/images/index_foot/hotel_2/02.jpg"><div><p style="font-size: 13px">度假村</p><p style="font-size: 12px;color: #cccccc">45561个度假村</p></div></li>
				<li class="container5list_8"><img src="resources/res/images/index_foot/hotel_2/03.jpg"><div><p style="font-size: 13px">别墅</p><p style="font-size: 12px;color: #cccccc">10789栋别墅</p></div></li>
				<li class="container5list_9"><img src="resources/res/images/index_foot/hotel_2/10.jpg"><div><p style="font-size: 13px">青旅</p><p style="font-size: 12px;color: #cccccc">108994间青旅</p></div></li>
				<li class="container5list_10"><img src="resources/res/images/index_foot/hotel_2/11.jpg"><div><p style="font-size: 13px">汽车旅馆</p><p style="font-size: 12px;color: #cccccc">10378间汽车旅馆</p></div></li>
				<li class="container5list_11"><img src="resources/res/images/index_foot/hotel_2/12.jpg"><div><p style="font-size: 13px">住宿加早餐旅馆</p><p style="font-size: 12px;color: #cccccc">40309家住宿加早餐旅馆</p></div></li>
