...
public class SearchHotel {
	...
	private int roomQuantity;	//住宿房量
	private int discount;		//折扣优惠
	private int frontDesk;		//24小时前台
	private int cancelPrepay;	//取消和预付
	private int mealDinner;		//餐点
	private int roomType;		//住处类型
	private String landMark;	//地标
	private int rating;			//评分
	private String chainHotels;	//连锁酒店
	private int searchHotelId;	//搜索酒店ID
